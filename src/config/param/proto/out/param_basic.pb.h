...
class BiotAppBasicParam final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:biot.BiotAppBasicParam) */ {
 public:
  ...
  inline void CopyFrom(const BiotAppBasicParam& from) {
