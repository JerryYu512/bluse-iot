...
const uint32_t TableStruct_param_5fmodule_2eproto::offsets[1] = {};
...
const char descriptor_table_protodef_param_5fmodule_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022param_module.proto\022\004biotb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_param_5fmodule_2eproto = {
    false, false, 34, descriptor_table_protodef_param_5fmodule_2eproto,
    "param_module.proto",
    &descriptor_table_param_5fmodule_2eproto_once, nullptr, 0, 0,
    schemas, file_default_instances, TableStruct_param_5fmodule_2eproto::offsets,
    nullptr, file_level_enum_descriptors_param_5fmodule_2eproto,
