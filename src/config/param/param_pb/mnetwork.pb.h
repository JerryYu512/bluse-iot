...
#ifndef GOOGLE_PROTOBUF_INCLUDED_mnetwork_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_mnetwork_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_mnetwork_2eproto
...
struct TableStruct_mnetwork_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mnetwork_2eproto;
namespace biot {
class BiotAppCmdApi;
...
enum EBiotLanType : int {
  ...
  LAN_WORK_AUTO = 4,
  LAN_WORK_1G_FULL = 5,
  EBiotLanType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  EBiotLanType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool EBiotLanType_IsValid(int value);
constexpr EBiotLanType EBiotLanType_MIN = LAN_WORK_10M_HALF;
constexpr EBiotLanType EBiotLanType_MAX = LAN_WORK_1G_FULL;
constexpr int EBiotLanType_ARRAYSIZE = EBiotLanType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EBiotLanType_descriptor();
template<typename T>
inline const std::string& EBiotLanType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EBiotLanType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EBiotLanType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EBiotLanType_descriptor(), enum_t_value);
}
inline bool EBiotLanType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EBiotLanType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EBiotLanType>(
    EBiotLanType_descriptor(), name, value);
}
enum NetIfRate : int {
  NET_IF_RATE_100M = 0,
  NET_IF_RATE_1000M = 1,
...
enum BiotAppModuleProtocl : int {
  MODULE_PROTOC_MQTT = 0,
  MODULE_PROTOC_NNG = 1,
  MODULE_PROTOC_PROTOBUF = 2,
  BiotAppModuleProtocl_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  BiotAppModuleProtocl_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool BiotAppModuleProtocl_IsValid(int value);
constexpr BiotAppModuleProtocl BiotAppModuleProtocl_MIN = MODULE_PROTOC_MQTT;
constexpr BiotAppModuleProtocl BiotAppModuleProtocl_MAX = MODULE_PROTOC_PROTOBUF;
constexpr int BiotAppModuleProtocl_ARRAYSIZE = BiotAppModuleProtocl_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* BiotAppModuleProtocl_descriptor();
template<typename T>
inline const std::string& BiotAppModuleProtocl_Name(T enum_t_value) {
  static_assert(::std::is_same<T, BiotAppModuleProtocl>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function BiotAppModuleProtocl_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    BiotAppModuleProtocl_descriptor(), enum_t_value);
}
inline bool BiotAppModuleProtocl_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, BiotAppModuleProtocl* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<BiotAppModuleProtocl>(
    BiotAppModuleProtocl_descriptor(), name, value);
}
...
class BiotAppLanParam final :
 ...
 public:
  ...
  void clear_type();
  ::biot::EBiotLanType type() const;
  void set_type(::biot::EBiotLanType value);
  private:
  ::biot::EBiotLanType _internal_type() const;
  void _internal_set_type(::biot::EBiotLanType value);
  public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_mnetwork_2eproto;
};
// -------------------------------------------------------------------
...
class BiotAppCmdApi final :
 ...
 public:
  ...
  void clear_trans();
  ::biot::BiotAppModuleProtocl trans() const;
  void set_trans(::biot::BiotAppModuleProtocl value);
  private:
  ::biot::BiotAppModuleProtocl _internal_trans() const;
  void _internal_set_trans(::biot::BiotAppModuleProtocl value);
  public:
...
inline ::biot::EBiotLanType BiotAppLanParam::_internal_type() const {
  return static_cast< ::biot::EBiotLanType >(_impl_.type_);
}
inline ::biot::EBiotLanType BiotAppLanParam::type() const {
  // @@protoc_insertion_point(field_get:biot.BiotAppLanParam.type)
  return _internal_type();
}
inline void BiotAppLanParam::_internal_set_type(::biot::EBiotLanType value) {
  
  _impl_.type_ = value;
}
inline void BiotAppLanParam::set_type(::biot::EBiotLanType value) {
...
inline ::biot::BiotAppModuleProtocl BiotAppCmdApi::_internal_trans() const {
  return static_cast< ::biot::BiotAppModuleProtocl >(_impl_.trans_);
}
inline ::biot::BiotAppModuleProtocl BiotAppCmdApi::trans() const {
  // @@protoc_insertion_point(field_get:biot.BiotAppCmdApi.trans)
  return _internal_trans();
}
inline void BiotAppCmdApi::_internal_set_trans(::biot::BiotAppModuleProtocl value) {
  
  _impl_.trans_ = value;
}
inline void BiotAppCmdApi::set_trans(::biot::BiotAppModuleProtocl value) {
...
template <> struct is_proto_enum< ::biot::EBiotLanType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::biot::EBiotLanType>() {
  return ::biot::EBiotLanType_descriptor();
}
...
template <> struct is_proto_enum< ::biot::BiotAppModuleProtocl> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::biot::BiotAppModuleProtocl>() {
  return ::biot::BiotAppModuleProtocl_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_mnetwork_2eproto
